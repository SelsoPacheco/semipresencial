...
Route::get('coaches/create', [CoachController::class, 'create'])->middleware(['auth', 'verified'])->name('index-coaches');
Route::post('coaches', [CoachController::class, 'store'])->middleware(['auth', 'verified'])->name('index-coaches');
Route::get('coaches/{id}/edit', [CoachController::class, 'edit'])->middleware(['auth', 'verified'])->name('index-coaches');
Route::put('coaches/{id}', [CoachController::class, 'update'])->middleware(['auth', 'verified'])->name('index-coaches');
Route::delete('coaches/{id}', [CoachController::class, 'destroy'])->middleware(['auth', 'verified'])->name('index-coaches');
